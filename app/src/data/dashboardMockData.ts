...
export const ORDERS: DashboardOrder[] = [
  {
    ...
    trackingHistory: [
      { status: 'received', timestamp: '2026-06-23T09:14:00Z', note: 'Order placed' },
  ...
  },
  {
    ...
    trackingHistory: [
      { status: 'received', timestamp: '2026-06-23T08:01:00Z' },
  ...
  },
  {
    ...
    trackingHistory: [
      { status: 'received', timestamp: '2026-06-22T16:42:00Z' },
  ...
  },
  {
    ...
    riderId: 'rider_01',
    trackingHistory: [
      { status: 'received', timestamp: '2026-06-22T12:20:00Z' },
      { status: 'processing', timestamp: '2026-06-22T12:55:00Z' },
      { status: 'in_transit', timestamp: '2026-06-22T18:00:00Z', note: 'Out for delivery - Tunde Adewale' },
    ],
  },
  {
    id: 'ORD-2026-1144',
    ...
    riderId: 'rider_02',
    trackingHistory: [
      { status: 'received', timestamp: '2026-06-21T10:10:00Z' },
      { status: 'processing', timestamp: '2026-06-21T10:45:00Z' },
      { status: 'in_transit', timestamp: '2026-06-22T09:30:00Z', note: 'En route - Kunle Bello' },
    ],
  },
  {
    id: 'ORD-2026-1143',
    ...
    riderId: 'rider_03',
    trackingHistory: [
      { status: 'received', timestamp: '2026-06-20T14:30:00Z' },
      { status: 'processing', timestamp: '2026-06-20T15:00:00Z' },
      { status: 'in_transit', timestamp: '2026-06-21T11:15:00Z', note: 'En route - Musa Ibrahim' },
    ],
  },
  {
    id: 'ORD-2026-1142',
    ...
    riderId: 'rider_04',
    trackingHistory: [
      { status: 'received', timestamp: '2026-06-19T09:50:00Z' },
      { status: 'processing', timestamp: '2026-06-19T10:20:00Z' },
      { status: 'in_transit', timestamp: '2026-06-19T17:00:00Z', note: 'En route - Femi Akinola' },
    ],
  },
  {
    id: 'ORD-2026-1141',
    ...
    riderId: 'rider_05',
    trackingHistory: [
      { status: 'received', timestamp: '2026-06-18T11:25:00Z' },
      { status: 'processing', timestamp: '2026-06-18T12:00:00Z' },
      { status: 'in_transit', timestamp: '2026-06-18T19:00:00Z' },
  ...
  },
  {
    ...
    riderId: 'rider_01',
    trackingHistory: [
      { status: 'received', timestamp: '2026-06-17T08:09:00Z' },
      { status: 'processing', timestamp: '2026-06-17T08:35:00Z' },
      { status: 'in_transit', timestamp: '2026-06-17T16:00:00Z' },
  ...
  },
  {
    ...
    riderId: 'rider_02',
    trackingHistory: [
      { status: 'received', timestamp: '2026-06-16T15:11:00Z' },
      { status: 'processing', timestamp: '2026-06-16T15:40:00Z' },
      { status: 'in_transit', timestamp: '2026-06-17T10:00:00Z' },
  ...
  },
  {
    ...
    riderId: 'rider_03',
    trackingHistory: [
      { status: 'received', timestamp: '2026-06-15T10:00:00Z' },
      { status: 'processing', timestamp: '2026-06-15T10:30:00Z' },
      { status: 'in_transit', timestamp: '2026-06-15T18:00:00Z' },
  ...
  },
  {
    ...
    riderId: 'rider_04',
    trackingHistory: [
      { status: 'received', timestamp: '2026-06-14T13:45:00Z' },
      { status: 'processing', timestamp: '2026-06-14T14:20:00Z' },
      { status: 'in_transit', timestamp: '2026-06-15T08:00:00Z' },
  ...
  },
  {
    ...
    riderId: 'rider_05',
    trackingHistory: [
      { status: 'received', timestamp: '2026-06-13T09:20:00Z' },
      { status: 'processing', timestamp: '2026-06-13T10:00:00Z' },
      { status: 'in_transit', timestamp: '2026-06-14T08:00:00Z' },
  ...
  },
  {
    ...
    trackingHistory: [
      { status: 'received', timestamp: '2026-06-12T16:30:00Z' },
  ...
  },
  {
    ...
    trackingHistory: [
      { status: 'received', timestamp: '2026-06-11T11:55:00Z' },
...
export const AUDIT_LOG: AuditLogEntry[] = [
  ...
  { id: 'log-15', timestamp: '2026-06-20T10:00:00Z', userId: 'usr_admin01', userName: 'Adaeze Nwosu', userRole: 'admin', action: 'status_change', entityType: 'order', entityId: 'ORD-2026-1141', entityLabel: 'Order ORD-2026-1141', summary: 'Marked as Delivered', changes: { before: { status: 'in_transit' }, after: { status: 'delivered' } } },
