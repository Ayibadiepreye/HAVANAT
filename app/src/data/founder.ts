...
export const FOUNDER = {
  ...
  shortBio:
    'Built Havanat to give working professionals the same calibre of tailoring the global elite take for granted — at a price that respects the realities of Lagos, Abuja, and Port Harcourt.',
  fullBio: [
    'Rapheal Ebipado Otele grew up surrounded by tailors — his family ran a small tailoring outfit in Lagos for two generations. He learned to cut fabric before he learned to code a spreadsheet, and the discipline of the cutting table stayed with him through every role he held afterwards.',
    ...
    'Today Rapheal leads the brand\'s creative direction and personally reviews every new collection before it reaches the fitting room.',
  ],
};
...
export const VALUES = [
  {
    ...
    desc: 'Every garment is cut from the finest Italian and British fabrics, and finished by hand in our Lagos atelier.',
  },
  {
    icon: Users,
...
export const MILESTONES = [
  { year: '2014', label: 'Havanat founded in a single Lagos atelier.' },
  { year: '2017', label: 'Opened the Victoria Island flagship store.' },
