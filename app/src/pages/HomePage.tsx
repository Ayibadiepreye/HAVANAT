    ...
    <section ref={heroRef} className="relative w-full h-screen overflow-hidden bg-black">
      ...
      <div className="hero-text relative z-10 flex flex-col items-center justify-center h-full text-center px-4">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 mt-10 sm:mt-14">
          <Link
            to="/shop"
            className="px-8 py-3.5 bg-white text-black text-[10px] sm:text-xs tracking-[0.15em] font-semibold hover:bg-white/90 transition-colors"
          >
            SHOP THE COLLECTION
          </Link>
          <Link
            to="/membership"
            className="px-8 py-3.5 border border-white/40 text-white text-[10px] sm:text-xs tracking-[0.15em] hover:bg-white/10 transition-colors"
          >
            JOIN THE CLUB
          </Link>
        </div>
    ...
    <section className="w-full py-20 lg:py-28 bg-white">
      <div className="px-4 sm:px-6 lg:px-12">
        <div className="flex items-end justify-between mb-12 lg:mb-16">
          ...
          <Link
            to="/shop"
            className="hidden sm:flex items-center gap-2 text-xs tracking-[0.15em] hover:opacity-60 transition-opacity"
          >
        ...
        <div className="sm:hidden mt-8 text-center">
          <Link
            to="/shop"
            className="inline-flex items-center gap-2 text-xs tracking-[0.15em]"
          >
            VIEW ALL <ArrowRight size={14} />
          </Link>
        </div>
    ...
    <section className="w-full py-20 lg:py-28 bg-[#f0f3f5]">
      <div className="px-4 sm:px-6 lg:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <div>
            <p className="text-[10px] tracking-[0.25em] text-gray-400 uppercase mb-4">The Havanat Standard</p>
            <h2 className="font-serif text-3xl sm:text-4xl lg:text-5xl leading-tight mb-6">
              Tailored for the<br />Modern Elite
            </h2>
            <p className="text-gray-600 leading-relaxed mb-6">
              Born from a passion for precision and an unwavering commitment to quality, Havanat redefines
              corporate fashion for the Nigerian professional. We believe that exceptional tailoring should not
          ...
          <div className="relative">
            <img
              ...
              alt="Professional wearing Havanat"
          ...
          {MEMBERSHIPS.map((tier) => (
            <div
              ...
              className={`relative p-8 border ${
                tier.isPopular ? 'border-white' : 'border-white/10'
              }`}
            >
              {tier.isPopular && (
  ...
  return (
    <section className="w-full py-20 lg:py-28 bg-white">
      <div className="px-4 sm:px-6 lg:px-12">
        <div className="flex items-end justify-between mb-12 lg:mb-16">
          <div>
            <p className="text-[10px] tracking-[0.25em] text-gray-400 uppercase mb-3">The Havanat Community</p>
        ...
        <div className="mt-20 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <blockquote className="font-serif text-2xl sm:text-3xl leading-relaxed mb-6">
              &ldquo;We started Havanat with a simple belief: every professional deserves to look and feel
              extraordinary. Not someday — today.&rdquo;
            </blockquote>
            <p className="text-gray-600 leading-relaxed mb-2">— Emmanuel Adeyemi, Founder & CEO</p>
            <Link
              to="/about"
              className="inline-flex items-center gap-2 text-xs tracking-[0.15em] mt-6 hover:opacity-60 transition-opacity"
            >
    ...
    <section className="w-full py-20 lg:py-28 bg-[#f0f3f5]">
      <div className="px-4 sm:px-6 lg:px-12 text-center max-w-2xl mx-auto">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3">
          ...
          <button
            type="submit"
            className="px-8 py-3.5 bg-black text-white text-xs tracking-[0.15em] font-semibold hover:bg-black/80 transition-colors"
          >
            SUBSCRIBE
          </button>
        </form>
        <p className="text-[10px] text-gray-400 mt-4 tracking-wide">
          By subscribing, you agree to receive marketing emails from Havanat.
        </p>
      </div>
    </section>
  );
